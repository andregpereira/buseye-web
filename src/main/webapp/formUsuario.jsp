...
<body>
  ...
  <main class="py-3">
  <div class="container">
  	<h5 class="ps-3 mb-2">Registrar usuário</h5>

	<c:if test="${registrado == true}">
	  <div class="d-flex justify-content-center mb-2">
		<p class="fs-5 bg-success p-2 m-0 rounded branco">Usuário registrado</p>
	  </div>
	</c:if>

    <form class="p-3 rounded" action="/Sprint4-POO/registrarUsuario" method="post">
      <div id="form" class="mb-5">
          <div class="mb-3">
            ...
            <input id="email" class="form-control" type="email" name="email" value="${email}" placeholder="nome@email.com" autofocus required>
          </div>
          <div>
            ...
            <input id="localizacao" class="form-control" type="text" name="localizacao" value="${localizacao}" required>
          </div>
      </div>
      ...
      <div class="d-flex flex-wrap justify-content-between text-center botoes">
        ...
        <div>
          ...
          <a href="/Sprint4-POO/listaUsuarios" class="btn btn-primary">Lista</a>
        </div>
      </div>
    </form>
  </div>
