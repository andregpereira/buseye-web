...
<title>Lista de ônibus - BusEye</title>
...
<body>
  ...
  <main class="px-4 py-3">
	<h5 class="ps-3 mb-2">Lista de ônibus</h5>

	<c:if test="${alterado == true}">
	  <div class="d-flex justify-content-center mb-2">
	  	<p class="fs-5 bg-success p-2 m-0 rounded branco">Ônibus ID ${onibus.idOnibus} alterado</p>
	  </div>
	</c:if>

	<c:if test="${removido == true}">
	  <div class="d-flex justify-content-center mb-2">
	  	<p class="fs-5 bg-danger p-2 m-0 rounded branco">Ônibus ID ${onibus.idOnibus} removido</p>
	  </div>
	</c:if>
	...
	<table class="table table-light table-striped table-hover table-bordered border-dark mb-2">
	  ...
	  <tbody>
	  <c:forEach items="${onibuss}" var="onibus">
		<tr>
		  <td>${onibus.idOnibus}</td>
		  <td>${onibus.localizacao}</td>
		  <td>${onibus.idFuncionario}</td>
		  <td>${onibus.idLinha}</td>
		  <td>${onibus.capacidade}</td>
		  <td>
			<div class="d-flex justify-content-around">
			  <a href="/Sprint4-POO/formAlterarOnibus?id=${onibus.idOnibus}" title="Editar">
				<span class="fas fa-edit acoes"></span>
			  </a>
			  <a href="/Sprint4-POO/removerOnibus?id=${onibus.idOnibus}"  title="Remover">
	...
	<c:otherwise>
	  <p class="fs-2 mb-3 text-center branco">Não há registros de ônibus</p>
	</c:otherwise>
	</c:choose>
  ...
  <div class="d-flex justify-content-end mt-3">
	<a href="/Sprint4-POO/formOnibus" class="btn btn-primary">Voltar</a>
  </div>
