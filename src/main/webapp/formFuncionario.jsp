...
<title>Funcionário - BusEye</title>
...
<body>
  ...
  <main class="py-3">
  <div class="container">
  	<h5 class="ps-3 mb-2">Registrar funcionário</h5>

	<c:if test="${registrado == true}">
	  <div class="d-flex justify-content-center mb-2">
		<p class="fs-5 bg-success p-2 m-0 rounded branco">Funcionário ${funcionarioRegistrado.nome} registrado</p>
	  </div>
	</c:if>

    <form class="p-3 rounded" action="/Sprint4-POO/registrarFuncionario" method="post">
      <div id="form" class="mb-5">
        <div id="col1">
          <div class="mb-3">
            ...
            <input id="nome" class="form-control" type="text" name="nome" value="${nome}" autofocus required>
          </div>
          <div class="mb-3">
            ...
            <input id="cpf" class="int form-control" type="text" name="cpf" value="${cpf}" required>
          </div>
          <div class="mb-3">
			...
			<input id="dataNascimento" class="form-control" type="date" name="dataNascimento" value="${dataNascimento}" required>
		  </div>
          <div id="espaco">
            ...
            <input id="email" class="form-control" type="email" name="email" value="${email}" placeholder="nome@email.com" required>
          </div>
        </div>
        ...
        <div id="col2">
          <div class="mb-3">
            ...
            <input id="telefone" class="int form-control" type="tel" name="telefone" value="${telefone}" required>
          </div>
          <div class="mb-3">
            ...
            <input id="cargo" class="form-control" type="text" name="cargo" value="${cargo}" required>
          </div>
          <div>
      ...
      <div class="d-flex flex-wrap justify-content-between text-center botoes">
        ...
        <div>
          ...
          <a href="/Sprint4-POO/listaFuncionarios" class="btn btn-primary">Lista</a>
        </div>
      </div>
    </form>
  </div>
