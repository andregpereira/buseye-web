...
<title>Lista de funcionários - BusEye</title>
...
<body>
  ...
  <main class="px-4 py-3">
	<h5 class="ps-3 mb-2">Lista de funcionários</h5>

	<c:if test="${alterado == true}">
	  <div class="d-flex justify-content-center mb-2">
	  	<p class="fs-5 bg-success p-2 m-0 rounded branco">Funcionário ${funcionarioAlterado.nome} alterado</p>
	  </div>
	</c:if>

	<c:if test="${removido == true}">
	  <div class="d-flex justify-content-center mb-2">
	  	<p class="fs-5 bg-danger p-2 m-0 rounded branco">Funcionário ${funcionarioRemovido.nome} removido</p>
	  </div>
	</c:if>
	...
	<table class="table table-light table-striped table-hover table-bordered border-dark mb-2">
	  ...
	  <c:forEach items="${funcionarios}" var="funcionario">
		<tr>
		  ...
		  <td><fmt:parseDate value="${funcionario.dataNasc}" pattern="yyyy-MM-dd" var="dataNasc"/>
		  <fmt:formatDate value="${dataNasc}" pattern="dd/MM/yyyy"/></td>
		  ...
		  <td>
			<div class="d-flex justify-content-around">
			  <a href="/Sprint4-POO/formAlterarFuncionario?id=${funcionario.idFuncionario}" title="Editar">
				<span class="fas fa-edit acoes"></span>
			  </a>
			  <a href="/Sprint4-POO/removerFuncionario?id=${funcionario.idFuncionario}"  title="Remover">
	...
	<c:otherwise>
	  <p class="fs-2 mb-3 text-center branco">Não há registros de funcionários</p>
	</c:otherwise>
	</c:choose>
  ...
  <div class="d-flex justify-content-end mt-3">
	<a href="/Sprint4-POO/formFuncionario" class="btn btn-primary">Voltar</a>
  </div>
