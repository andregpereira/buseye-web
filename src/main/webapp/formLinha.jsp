...
<body>
  ...
  <main class="py-3">
  <div class="container">
  	<h5 class="ps-3 mb-2">Registrar linha</h5>

	<c:if test="${registrado == true}">
	  <div class="d-flex justify-content-center mb-2">
		<p class="fs-5 bg-success p-2 m-0 rounded branco">Linha ${linha.nome} registrada</p>
	  </div>
	</c:if>

	<c:if test="${repetido == true}">
	  <div class="d-flex justify-content-center mb-2">
		<p class="fs-5 bg-danger p-2 m-0 rounded branco">Linha já existente</p>
	  </div>
	</c:if>

    <form class="p-3 rounded" action="/Sprint4-POO/registrarLinha" method="post">
      <div id="form" class="mb-5">
          ...
          <div class="mb-3">
            <label class="form-label" for="duracaoPercurso">Duração do percurso (hh:mm)</label>

          	  <c:if test="${duracaoInvalida == true}">
              	<div class="fw-bold" style="color: red">Duração do percurso inválida</div>
          	  </c:if>

            <input id="duracaoPercurso" class="form-control" type="time" name="duracaoPercurso" value="${duracaoPercurso}" min="00:01" required>
          </div>
          ...
          <div>
            ...
            <input id="idFuncionario" class="int form-control" type="number" name="idFuncionario" value="${idFuncionario}" required>
          </div>
      </div>
      ...
      <div class="d-flex flex-wrap justify-content-between text-center botoes">
        ...
        <div>
          ...
          <a href="/Sprint4-POO/listaLinhas" class="btn btn-primary">Lista</a>
        </div>
      </div>
    </form>
  </div>
