...
<title>Alterar ônibus - BusEye</title>
...
<body>
  ...
  <main class="py-3">
  <div class="container">
  	<h5 class="ps-3 mb-2">Alterando ônibus ID ${onibus.idOnibus}</h5>
    ...
    <form class="p-3 rounded" action="/Sprint4-POO/alterarOnibus" method="post">
      <div id="form" class="mb-5">
		  <div class="mb-3">
			<input type="hidden" name="id" value="${onibus.idOnibus}">
            ...
            <input id="localizacao" class="form-control" type="text" name="localizacao" value="${onibus.localizacao}" maxlength="30" autofocus required>
          </div>
          ...
          <div class="mb-3">
            ...
            <input id="idFuncionario" class="int form-control" type="number" name="idFuncionario" value="${onibus.idFuncionario}" min="1" required>
          </div>
          ...
          <div class="mb-3">
            ...
            <input id="idLinha" class="int form-control" type="number" name="idLinha" value="${onibus.idLinha}" min="1" required>
          </div>
          ...
          <div>
            ...
            <input id="capacidade" class="int form-control" type="number" name="capacidade" value="${onibus.capacidade}" min="1" max="100" required>
          </div>
      </div>
      ...
      <div class="d-flex flex-wrap justify-content-between text-center botoes">
        ...
        <div>
          ...
          <a href="/Sprint4-POO/listaOnibus" class="btn btn-primary">Voltar</a>
        </div>
      </div>
    </form>
  </div>
