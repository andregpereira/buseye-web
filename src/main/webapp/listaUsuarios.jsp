...
<title>Lista de usuários - BusEye</title>
...
<body>
  ...
  <main class="px-4 py-3">
	<h5 class="ps-3 mb-2">Lista de usuários</h5>

	<c:if test="${alterado == true}">
	  <div class="d-flex justify-content-center mb-2">
	  	<p class="fs-5 bg-success p-2 m-0 rounded branco">Usuário ID ${usuario.idUsuario} alterado</p>
	  </div>
	</c:if>

	<c:if test="${removido == true}">
	  <div class="d-flex justify-content-center mb-2">
	  	<p class="fs-5 bg-danger p-2 m-0 rounded branco">Usuário ID ${usuario.idUsuario} removido</p>
	  </div>
	</c:if>
		...
		<tr>
		  ...
		  <td>
			<div class="d-flex justify-content-around">
			  <a href="/Sprint4-POO/formAlterarUsuario?id=${usuario.idUsuario}" title="Editar">
				<span class="fas fa-edit acoes"></span>
			  </a>
			  <a href="/Sprint4-POO/removerUsuario?id=${usuario.idUsuario}"  title="Remover">
	...
	<c:otherwise>
	  <p class="fs-2 mb-3 text-center branco">Não há registros de usuários</p>
	</c:otherwise>
	</c:choose>
  ...
  <div class="d-flex justify-content-end mt-3">
	<a href="/Sprint4-POO/formUsuario" class="btn btn-primary">Voltar</a>
  </div>
